...
<head>
    ...
    <link rel="stylesheet" href="style.css"> <!-- Here goes the CSS -->
...
<section class="vh-180">
    <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <!-- Here goes the content of the database -->
            <div class="row">
                <a class="btn btn-success" href="create.php">Add</a>
                <!-- Here enter data from the table -->
                <table class="table table-striped">
                    ...
                    include "banco.php";
                    $pdo = Banco::conectar();
                    $sql = "SELECT * FROM tb_alunos ORDER BY codigo DESC"; // Fixed SQL syntax
                    foreach ($pdo->query($sql) as $row) {
                        ...
                        echo '<td>' . $row['idade'] . '</td>'; // Corrected syntax
                        echo '<td width="7%">';
